...
urlpatterns = [
    ...
    path('api/status/', include(('app_dir.status.api.urls', 'status_api'), namespace='status_api')),
    path('api/auth/', include(('app_dir.accounts.api.urls', 'auth_api'), namespace='auth_api'))
]
